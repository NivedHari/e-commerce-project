...
const About = () => {
  return (
    <>
      ...
      <div className="d-flex flex-row align-items-center justify-content-center mx-5">
        <img
          src={Members}
          alt="Members"
          className="rounded-circle img-thumbnail mb-5 mx-5"
          style={{ width: "250px", height: "250px" }} 
        />
        <p className="text-center my-5 mx-5">
